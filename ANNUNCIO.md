...
**🆕 Wizard del cervello:** al primo avvio ti guida a scegliere e attivare l'AI (Ollama glm-4.7 automatico, provider cloud o modello locale).
...
**🆕 Brain wizard:** on first launch it guides you to pick and activate the AI (automatic Ollama glm-4.7, cloud provider, or local model).
...
**🆕 Gehirn-Assistent:** beim ersten Start führt er dich zur Auswahl und Aktivierung der KI (automatisches Ollama glm-4.7, Cloud-Anbieter oder lokales Modell).
...
**🆕 Asistente de cerebro:** en el primer inicio te guía para elegir y activar la IA (Ollama glm-4.7 automático, proveedor en la nube o modelo local).
...
*Decodius è un progetto open source (licenza MIT) di Martino, IU8LMC.*
